    ...
    <div className="flex flex-row" >
        ...
        <div className="flex flex-col">
            ...
            <div className="bar bg-white md:mx-0 mx-6 md:mr-40 mt-6 rounded-sm">
                <div className="items-center justify-center flex flex-col pt-20 md:pt-28 pb-20 md:pb-28 mx-auto mb-20 " >
                    ...
                    xmlns="http://www.w3.org/2000/svg" width="131" height="137" viewBox="0 0 131 137" fill="none">
                        <g opacity="0.5">
                            ...
                            <path d="M71.2618 58.9929C71.2618 58.9929 83.6245 77.5674 76.1439 77.8313C68.6634 78.0952 68.0239 76.1363 68.0239 76.1363" fill="white"/>
                            <path d="M74.804 78.42C68.5313 78.42 67.6279 76.7047 67.5061 76.39C67.4185 76.1129 67.5668 75.8162 67.8411 75.7201C68.1155 75.6331 68.4091 75.7821 68.5008 76.0551C68.5008 76.0551 69.4143 77.6283 76.1235 77.3847C76.7911 77.4463 77.4334 77.1132 77.7678 76.5321C79.3715 73.4161 73.3018 63.0834 70.8252 59.3685C70.6873 59.1285 70.7583 58.8228 70.9878 58.668C71.2172 58.5133 71.5272 58.562 71.6981 58.7798C72.642 60.2008 80.8331 72.7868 78.7016 77.0498C78.204 77.9777 77.2156 78.5352 76.1641 78.4809L74.804 78.42Z" fill="#3A4374"/>
                ...
                {/* If feedback present, Map comments from the JSON Data */} 
                <div className="grid grid-rows-6 bg-white rounded-lg md:mr-40">
                    <div className="flex flex-col md:flex-row mx-6  border border-rose-500 " >
